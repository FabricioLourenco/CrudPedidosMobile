...
class PedidoService {
  ...
  String url = "http://localhost:8080/pedido/salvar";
  ...
  Future<dynamic> editarPedido(String id, PedidoModel pedido) async {
    final url = "http://localhost:8080/pedido/editar"; // Rota para editar pedido
  ...
  Future<bool> deletarPedido(String id) async {
    final url = "http://localhost:8080/pedido/remover/$id"; // Rota para deletar pedido
